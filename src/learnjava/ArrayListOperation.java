...
public class ArrayListOperation {
    ...
    private static void addArrayList() {            // add elements to arraylist
    ...
    private static void displayAll() {          //display all value
    ...
    private static void InsertArrayList() {         //inser into nth position
    ...
    private static void DeleteNth() {               //delete from nth position
        if (size == 0) {
            System.out.print("\n ArrayList is empty\n");
        } else {
    ...
    private static void UpdateArrayList() {             //update nth position
